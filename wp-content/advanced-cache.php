...
$rocket_cache_path  = '/Applications/MAMP/htdocs/shopnaklik/wp-content/cache/wp-rocket/';
$rocket_config_path = '/Applications/MAMP/htdocs/shopnaklik/wp-content/wp-rocket-config/';

if ( file_exists( '/Applications/MAMP/htdocs/shopnaklik/wp-content/plugins/wp-rocket/inc/front/process.php' ) && version_compare( phpversion(), '5.4' ) >= 0 ) {

	spl_autoload_register( function( $class ) {
		$rocket_path    = '/Applications/MAMP/htdocs/shopnaklik/wp-content/plugins/wp-rocket/';
		$rocket_classes = [
	...
	include '/Applications/MAMP/htdocs/shopnaklik/wp-content/plugins/wp-rocket/inc/front/process.php';
} else {
