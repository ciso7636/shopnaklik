...
<div class="main" id="main">
    ...
    <ul id="pages">
        <li style="display: none;" id="newPageLI">
            ...
            <span class="pageButtons">
                ...
                <a href="" class="fileClone"><span class="fa fa-clone"></span></a>
    ...
    <div class="text-center clearfix">
        <a href="#impExpModal" data-toggle="modal" class="btn btn-info btn-sm btn-embossed">Import / Export Project</a>
    </div>
...
<div id="hidden">
<iframe src="<?php echo get_stylesheet_directory_uri(). '/builder/elements/skeleton.html'?>" id="skeleton"></iframe>
</div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title"><span class="fui-export"></span> Export Your Markup</h4>
            </div>


            <div class="modal-body">

                <!-- Graphicfort New Elements -->

                <!-- Title -->
                <div class="form-group">
                    <label for="page-title" class="col-sm-12">Page title</label>
                    <div class="col-sm-12">
                        <input type="text" class="form-control" name="page_title" id="page-title" placeholder="" value="Page Title">
                    </div>
                </div>

                <!-- Meta Description -->
                <div class="form-group">
                    <label for="meta-desc" class="col-sm-12">Page meta description</label>
                    <div class="col-sm-12">
                        <textarea class="form-control" name="meta_desc" id="meta-desc" placeholder=""></textarea>
                    </div>
                </div>

                <!-- Page Meta Keywords -->
                <div class="form-group">
                    <label for="meta-keywords" class="col-sm-12">Page meta keywords</label>
                    <div class="col-sm-12">
                        <textarea class="form-control" name="meta_keywords" id="meta-keywords" placeholder=""></textarea>
                    </div>
                </div>


                <!-- Full Width Page -->
                <div class="form-group fullwidth-switch">

                    <label for="fullwidth-switch" class="col-sm-12">Full Width Page</label>

                    <div class="col-sm-12">
                        <input type="checkbox" name="full_width_switch" id="fullwidth-switch" data-toggle="switch" />
                    </div>
                ...
                <!-- Page Loader -->
                <div class="form-group loader-switch">

                    <label for="loader-switch" class="col-sm-12">Page Loader</label>

                    <div class="col-sm-12">

                        <input type="checkbox" name="page_loader" id="loader-switch" data-toggle="switch" checked />

                        <div class="row loader-options" style="padding-top: 20px;">

                            <div class="col-md-2">
                                <label class="radio" style="padding-top: 0;">
                                    1
                                    <input type="radio" name="loader_no" value="1" data-toggle="radio">
                                </label>
                            </div>
                            ...
                            <div class="col-md-2">
                                <label class="radio" style="padding-top: 0;">
                                    2
                                    <input type="radio" name="loader_no" value="2" data-toggle="radio">
                                </label>
                            </div>
                            ...
                            <div class="col-md-2">
                                <label class="radio" style="padding-top: 0;">
                                    3
                                    <input type="radio" name="loader_no" value="3" data-toggle="radio">
                                </label>
                            </div>
                            ...
                            <div class="col-md-2">
                                <label class="radio" style="padding-top: 0;">
                                    4
                                    <input type="radio" name="loader_no" value="4" data-toggle="radio">
                                </label>
                            </div>
                            ...
                            <div class="col-md-2">
                                <label class="radio" style="padding-top: 0;">
                                    5
                                    <input type="radio" name="loader_no" value="5" data-toggle="radio">
                                </label>
                            </div>
                            ...
                            <div class="col-md-2">
                                <label class="radio" style="padding-top: 0;">
                                    6
                                    <input type="radio" name="loader_no" value="6" data-toggle="radio" checked>
                                </label>
                            </div>
...
<!-- import / export Project popup -->
<div class="modal fade" id="impExpModal" tabindex="-1" role="dialog" aria-hidden="true">
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
            <h4 class="modal-title">Import / Export Project File</h4>
        </div>
        ...
        <div class="modal-body">
            <div class="row text-center" style="padding: 50px 0;">
                ...
                <div class="col-sm-6">
                    ...
                    <!-- Export -->
                    <form action="export-template.php" id="export-builder-template" method="post" target="_blank">
                        <a href="#" id="exportProject" class="btn btn-primary btn-embossed">
                            <span class="fa fa-download"></span> <span class="bLabel">Save Project File</span>
                        </a>
                    </form><!-- /End Export -->
                ...
                <div class="col-sm-6">
                    ...
                    <span class="btn btn-primary btn-file btn-embossed">
                        <span class="fa fa-upload"></span> <span class="bLabel">Upload Project File</span> <input type="file" id="importProject"/>
                    </span>
            ...
            <span class="note">*Note: after the import process all the current pages will be deleted!</span>

        </div><!-- /.modal-body -->


        <div class="modal-footer">
            <button type="button" class="btn btn-default btn-embossed" data-dismiss="modal" id="impExpCancel">Cancel &amp; Close</button>
        </div>
...
<!-- Error import Project popup -->
<div class="modal fade" id="errorImpModal" tabindex="-1" role="dialog" aria-hidden="true">
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <span class="note">It looks like the uploaded file isn't a builder file</span>
...
<!-- Proceed or not import Project popup -->
<div class="modal fade" id="impProjectFileModal" tabindex="-1" role="dialog" aria-hidden="true">
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <span class="note">All the pages will be detelted and will be replaced with the backup file content, are you sure you want to do that.</span>
        </div><!-- /.modal-body -->


        <div class="modal-footer">
            <button type="button" class="btn btn-default btn-embossed" data-dismiss="modal">Cancel &amp; Close</button>
            <button type="button" class="btn btn-primary btn-embossed" id="impProjectFile">Yes</button>
        </div>
...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
            <h4 class="modal-title"><span class="fui-window"></span> Preview Page</h4>
        </div>
        <div class="modal-body">
...
<div id="loader">
<img src="<?php echo get_stylesheet_directory_uri(). '/builder/images/loading.gif'?>" alt="Loading...">
Loading elements...
</div>
